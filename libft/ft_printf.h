...
void			set_fflags(char *str, int *i,
		t_flags**st_flag, int *free_fflag);
...
char			*format_str(char *str, char f,
		t_flags *st_flags, int *free_tstr);
